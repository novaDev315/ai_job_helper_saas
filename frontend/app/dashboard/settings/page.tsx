          ...
          <CardContent className="space-y-4">
            <div className="p-4 border rounded-lg bg-primary/5">
              ...
              <div className="space-y-1 text-sm text-muted-foreground">
                <p>• 3 CV optimizations per month</p>
                <p>• 5 cover letters per month</p>
            ...
            <div className="space-y-2">
              ...
              <Button className="w-full">Upgrade to Pro - $29/month</Button>
            </div>
            ...
            <div className="pt-4 border-t">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">CV Optimizations</span>
            ...
            <div className="space-y-4">
              {Object.entries(notifications).map(([key, value]) => (
                <div key={key} className="flex items-center justify-between">
                  <Label htmlFor={key} className="flex flex-col gap-1 cursor-pointer">
